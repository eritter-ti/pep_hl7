...
CREATE TABLE `vacina_aplicada` (
  `idVACINA_APLICADA` int(11) NOT NULL,
  `LOTE` varchar(45) DEFAULT NULL,
  `DATA_APLICACAO` date DEFAULT NULL,
  `DOSE_idDOSE` int(11) NOT NULL,
  PRIMARY KEY (`idVACINA_APLICADA`,`DOSE_idDOSE`),
  KEY `fk_VACINA_APLICADA_DOSE1` (`DOSE_idDOSE`),
  CONSTRAINT `fk_VACINA_APLICADA_DOSE1` FOREIGN KEY (`DOSE_idDOSE`) REFERENCES `dose` (`idDOSE`) ON DELETE NO ACTION ON UPDATE NO ACTION
